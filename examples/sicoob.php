    ...
    <div class="container">
        ...
        <tr>
          <td>
            <strong class="txt-small">
              Linha digitável: <?= $sicoob->linhaDigitavel(true) ?>
            </strong><br>
            <strong class="txt-small">
              Valor: R$ <?= number_format($sicoob->getValor(), 2, ',', '.') ?>
            </strong>
          </td>
        </tr>
        <tr><td>&nbsp;</td><tr>
      ...
      <table cellpadding="0" cellspacing="0">
            ...
            <table cellspacing="0" cellspacing="0">
              <tr>
                <td class="brd-b" width="150" valign="bottom">
                  <img src="img/sicoob.png" width="150">
                </td>
                <td class="brd-b" width="120" valign="bottom">
                  <strong class="center txt-bigger">| <?= $sicoob->getBanco() ?>-0 |</strong>
                </td>
                <td class="brd-b" valign="bottom">
                  <div class="right txt-big"><?= $sicoob->linhaDigitavel(true) ?></div>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
            ...
            <table cellpadding="0" cellspacing="0">
              <tr>
                <td class="brd-b brd-r" valign="top">
                  ...
                  <strong class="right">
                    <?= str_pad($sicoob->getNumeroDocumento(), 7, 0, STR_PAD_LEFT) ?>
                  </strong>
                </td>
                <td class="brd-b brd-r" valign="top">
                ...
                <td class="brd-b brd-r" valign="top">
                  ...
                  <strong class="center">
                    <?= date('d/m/Y', strtotime($sicoob->getVencimento())) ?>
                  </strong>
                </td>
              </tr>
            </table>
          ...
          <td class="brd-b brd-l" valign="top">
            ...
            <strong class="right">
              R$ <?= number_format($sicoob->getValor(), 2, ',', '.') ?>
            </strong>
          </td>
        </tr>
        ...
        <tr>
          <td valign="top">
            ...
            <strong class="left txt-small">
              <br><?= implode('<br>', $sicoob->getDemonstrativo()) ?>
            </strong>
          </td>
          <td valign="top">
      ...
      <table cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td class="brd-t brd-b brd-l" valign="top">
            <small>Vencimento</small>
            <strong class="right"><?= date('d/m/Y', strtotime($sicoob->getVencimento())) ?></strong>
          </td>
        </tr>
        <tr>
          <td class="brd-t brd-b brd-r" valign="top">
            ...
            <table cellpadding="0" cellspacing="0">
              <tr>
                <td class="brd-b brd-r" valign="top">
                  ...
                  <strong class="right">
                    <?= date('d/m/Y', strtotime($sicoob->getDataDocumento())) ?>
                  </strong>
                </td>
                <td class="brd-b brd-r" valign="top">
                  <small>N. do Documento</small>
                ...
                <td class="brd-b brd-r" valign="top">
                  ...
                  <strong class="right">
                    <?= date('d/m/Y', strtotime($sicoob->getDataProcessamento())) ?>
                  </strong>
                </td>
              </tr>
            </table>
            ...
            <table cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td class="brd-b brd-r" valign="top">
                  ...
                  <strong class="center"><?= $sicoob->getCarteira() ?></strong>
                </td>
                <td class="brd-b brd-r" valign="top">
                  <small>Espécie</small>
                  <strong class="center"><?= $sicoob->getEspecie() ?></strong>
                </td>
                <td class="brd-b brd-r" valign="top">
                  <small>Quantidade</small>
                  <strong class="center">&nbsp;</strong>
        ...
        <tr>
          <td rowspan="5" class="brd-b brd-r" valign="top">
            ...
            <strong class="left txt-small"><br><?= implode('<br>', $sicoob->getInstrucoes()) ?></strong>
          </td>
          <td class="brd-b brd-l" valign="top">
